    ...
    <div class="container">
        ...
        <div class="card my-4">
            <div class="card-body">
                ...
                <form action="{{ route('techinical.store') }}" id="technical-form" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3 text-center">
                                <button class="btn btn-success" id="technical-save">Salvar</button>
                            </div>
                        </div>
                </form>
            </div>
