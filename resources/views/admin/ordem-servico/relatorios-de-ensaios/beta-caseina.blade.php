...
<head>
    ...
    <title>Relatório de ensaio de Beta Caseína</title>
...
<body>
    <div class="container">
        ...
        <div class="mb-1">
            <p class="section-title">BETA CASEÍNA</p>
            ...
            <p>Método: <span>PCR alelo específico</span></p>
        </div>
        <div class="mb-5">
        ...
        <div class="result mb-3">
            <p>Homozigoto Mutante (A1A1): <span>Possui a mutação em ambos os cromossomos.</span></p>
            <p>Homozigoto Selvagem (A2A2): <span>Não possui a mutação.</span></p>
            <p>Heretozigoto (A1A2): <span>Possui a mutaçao em um dos cromossomos.</span></p>
            <p>Data de emissão: <span></span></p>
