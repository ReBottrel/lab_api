            ...
            <table width="95%" class="table-laudo2" border="1" align="center">
                ...
                <tr>
                    ...
                    <td>
                        <table cellpadding="10">
                            <tr>
                                <td style="border-bottom-style: solid; border-bottom-width: 1px;">Nome/Lote do Antígeno:
                                    *********************************************************</td>
                            </tr>
                            <tr>
                                <td style="border-bottom-style: solid; border-bottom-width: 1px;">Data do Resultado do
                                    Exame: ***************************************************
                            </tr>
                            <tr>
                                <td style="border-bottom-style: solid; border-bottom-width: 1px;">
                                    <p style="margin-bottom: 4px">Resultado:</p>&nbsp;&nbsp;Relatório de ensaio emitido
                                    conforme Instrução Normativa nº 52, 26 de novembro de 2018 do MAPA.
                                </td>
                            </tr>
                            <tr>
                                <td style="border-bottom-style: solid; border-bottom-width: 1px;">Validade do Resultado:
                                    ********************************************************</td>
                            </tr>
                            <tr>
                ...
                <tr>
                    <td colspan="2" style="font-size: 9px;" align="center">
                        1 - JC: Jockey Club&nbsp;&nbsp;&nbsp;&nbsp;SH: Sociedade Hípica&nbsp;&nbsp;&nbsp;&nbsp;H: Haras
                ...
                <tr>
                    <td colspan="2" style="font-size: 9px;">
                        ...
                        <p style="margin-bottom:0px">
                            Obs: É obrigatória a entrega ao laboratório, juntamente com esta requisição e as amostras
